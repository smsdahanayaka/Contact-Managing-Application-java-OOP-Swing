...
class UpdateContact extends JFrame{
	...
	UpdateContact(){
			...
			btnSearch.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent evt){
					...
					if(i>=0){
						...
						conId=contactDetails.getContactId();
		...
		btnDelete=new JButton("Update Contact");
					...
					String contactNumber=tfNumber.getText();
						...
						if(ContactController.verifyBday(birthDay)){
							...
							if(ContactController.checkSal(salary)){
								...
								ContactDetails contactDetails1=new ContactDetails(conId,contactName,contactNumber,companyName,birthDay,salary);
								contactDetails=contactDetails1;
								boolean isAdd=ContactController.addContact(i,contactDetails);
	...
	private void closeUpdateContact() {
			dispose(); 
		}	
